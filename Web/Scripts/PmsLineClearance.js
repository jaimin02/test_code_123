...
var vWorkSpaceId;
var setworkspaceid = "";
var ModuleName = "Line Clearance";
var tab = false;
var UserTypeCode = "";
var vProjectNo = "";
var iTypeOfAccordian = '';
...
$(function () {
    ...
    $('#heading').on("click", function () {
        ...
        $('#AccountcollapseOne').collapse('hide');
        $('#AccountcollapseTwo').collapse('hide');
        //$('#collapseThree').collapse('hide');
        $('#AccountcollapseFour').collapse('hide');
    });
    ...
    $('#headingTwo').on("click", function () {
        ...
        tab = false;
        iTypeOfAccordian = "2";
        $('#dvLineProduct').appendTo($('#dvProduct').html());
        $('#dvProduct').show();
        $("#btnGo")[0].click();
    });
    ...
    $('#AccountheadingOne').on("click", function () {
        $('#collapse').collapse('hide');
        $('#AccountcollapseOne').collapse('show');
        $('#AccountcollapseTwo').collapse('hide');
        //$('#collapseThree').collapse('hide');
        $('#AccountcollapseFour').collapse('hide');
        tab = false;
    ...
    $('#AccountheadingTwo').on("click", function () {
        $('#collapse').collapse('hide');
        $('#AccountcollapseOne').collapse('hide');
        $('#AccountcollapseTwo').collapse('show');
        //$('#collapseThree').collapse('hide');
        $('#AccountcollapseFour').collapse('hide');
        tab = false;
        iTypeOfAccordian = "2";
    ...
    $('#AccountheadingFour').on("click", function () {
        $('#collapse').collapse('hide');
        $('#AccountcollapseOne').collapse('hide');
        $('#AccountcollapseTwo').collapse('hide');
        //$('#collapseThree').collapse('hide');
        $('#AccountcollapseFour').collapse('show');
        tab = false;
        iTypeOfAccordian = "4";
        $("#btnGo")[0].click();
    });
    ...
    $('#DDLAccountProductType').on("change", function () {
    ...
    $('#DDLAccountProduct').on("change", function () {
    ...
    $('#ddlAccountBatchLotNo').on('change', function () {
        tab = true;
        iTypeOfAccordian = "2";
        $("#AccountheadingTwo").click();
...
function SetDefaultValue() {
    ...
    $('#DDLAccountProductType').val(0).attr("selected", "selected");
    $('#DDLAccountProduct').val(0).attr("selected", "selected");
    $('#ddlAccountBatchLotNo').val(0).attr("selected", "selected");

    $("#divAccountabilityLineClearance").hide();
    $("#divLineClearance").hide();
    //$('#DDLProjectNo').val('');
}
...
function GetProductName() {
    ...
    if (document.getElementById('LineClearance').checked) {
        var nProductTypeID = $("#DDLProductType").val();
    }
    else {
        var nProductTypeID = $("#DDLAccountProductType").val();
    }
    ...
    $.ajax({
        ...
        success: function (jsonData) {
            ...
            if (jsonData.length > 0) {
                ...
                $("#DDLAccountProduct").empty().append('<option selected="selected" value="0">Please Select Product</option>');
                for (var i = 0; i < jsonData.length; i++) {
                    $("#DDLAccountProduct").append($("<option></option>").val(jsonData[i].nProductNo).html(jsonData[i].vProductName));
...
function GetBatchLotNo() {
    ...
    if (document.getElementById('LineClearance').checked) {
        ...
        var nProductNo = $("#DDLAccountProduct").val();
    }
    ...
    function SuccessMethod(jsonData) {
        if (jsonData.length > 0) {
            ...
            $("#ddlAccountBatchLotNo").empty().append('<option selected="selected" value="0">Please Select Batch/Lot/Lot No</option>');
            for (var i = 0; i < jsonData.length; i++) {
                $("#ddlBatchLotNo").append($("<option></option>").val(jsonData[i].nStudyProductBatchNo).html(jsonData[i].vBatchLotNo));
                $("#ddlAccountBatchLotNo").append($("<option></option>").val(jsonData[i].nStudyProductBatchNo).html(jsonData[i].vBatchLotNo));
            }
        }
        else {
            $("#ddlBatchLotNo").empty().append('<option selected="selected" value="0">Please Select Batch/Lot/Lot No</option>');
    ...
    if (setworkspaceid != "") {
        ...
        $.ajax({
            ...
            success: function (jsonData) {
                ...
                $("#DDLAccountProductType").empty().append('<option selected="selected" value="0">Please Select Product Type</option>');
                for (var i = 0; i < jsonData.length; i++) {
                    $("#DDLProductType").append($("<option></option>").val(jsonData[i].nProductTypeID).html(jsonData[i].vProductType));
                    $("#DDLAccountProductType").append($("<option></option>").val(jsonData[i].nProductTypeID).html(jsonData[i].vProductType));
...
$("#btnGo").click(function () {
    ...
    if (ValidateForm()) {
        if (tab == true) {
            ...
            else if (document.getElementById('AccountabilityLineClearance').checked) {
        ...
        if (document.getElementById('LineClearance').checked) {
            ...
            $("#divAccountabilityLineClearance").show();
            $("#divLineClearance").hide();
            mode = "ACCOUNTABILITY";
            nProductTypeID = $("#DDLAccountProductType").val();
            nProductNo = $("#DDLAccountProduct").val();
            nBatchNo = $("#ddlAccountBatchLotNo :selected").val();
        }
        ...
        var FilterData = {
            ...
            Mode: mode,
            iTypeOfAccordian : iTypeOfAccordian

        }

        //if (document.getElementById('LineClearance').checked) {
        //    $("#divLineClearance").style('display', 'block');
        //    $("#divAccountabilityLineClearance").style('display', 'none');
        ...
        //}
        //else if (document.getElementById('AccountabilityLineClearance').checked) {
        //    $("#divLineClearance").style('display', 'none');
        //    $("#divAccountabilityLineClearance").style('display', 'block');
        //}
...
var GetAllLineClearance = function (Url, SuccessMethod, Data) {
    $.ajax({
        ...
        success: SuccessMethod,
        error: function () {
            SuccessorErrorMessageAlertBox("Line Clearance Detail not found.", ModuleName);
        }
    });
    function SuccessMethod(jsonData) {
        ...
        if (document.getElementById('LineClearance').checked) {
            ...
            if ($('#AccountcollapseOne').attr('aria-expanded') == "true") {
                var ActivityDataset = [];
                ...
                for (var i = 0; i < jsonData.Accordian1.length; i++) {
                    ...
                    $radioYes = '<input class="radio" type="radio" name=radio_' + [i + 1] + ' id=chkAccountYes_' + [1] + [i + 1] + ' value="Yes"/>';
                    $radioNo = '<input class="radio" type="radio" name=radio_' + [i + 1] + ' id=chkAccountNo_' + [1] + [i + 1] + ' value="No"/>';

                    InDataset.push(i + 1, jsonData.Accordian1[i].vCheckPoints, $radioYes, $radioNo, jsonData.Accordian1[i].vUserName, jsonData.Accordian1[i].dModifyOn, review, '', '', jsonData.Accordian1[i].nLineClearanceDtlNo, jsonData.Accordian1[i].cIsYesNo, jsonData.Accordian1[i].cIsQAReview, jsonData.Accordian1[i].vWorkSpaceId, jsonData.Accordian1[i].nProductNo, jsonData.Accordian1[i].nProductTypeID, jsonData.Accordian1[i].nStudyProductBatchNo, jsonData.Accordian1[i].iPeriod);
                    ActivityDataset.push(InDataset);

                }
                tableid = "tblAccountPmsLineClearance1";
                divid = "AccountLineClearance1"
                document.getElementById(divid).style.visibility = "visible";
                document.getElementById(tableid).style.visibility = "visible";

            }
            else if ($('#AccountcollapseTwo').attr('aria-expanded') == "true") {
                var ActivityDataset = [];
                ...
                for (var i = 0; i < jsonData.Accordian2.length ; i++) {
                    ...
                    var InDataset = [];
                    $radioYes = '<input class="radio" type="radio" name=radio_' + [i + 1] + ' id=chkAccountYes_' + [2] + [i + 1] + ' value="Yes"/>';
                    $radioNo = '<input class="radio" type="radio" name=radio_' + [i + 1] + ' id=chkAccountNo_' + [2] + [i + 1] + ' value="No"/>';

                    InDataset.push(i + 1, jsonData.Accordian2[i].vCheckPoints, $radioYes, $radioNo, jsonData.Accordian2[i].vUserName, jsonData.Accordian2[i].dModifyOn, review, '', '', jsonData.Accordian2[i].nLineClearanceDtlNo, jsonData.Accordian2[i].cIsYesNo, jsonData.Accordian2[i].cIsQAReview, jsonData.Accordian2[i].vWorkSpaceId, jsonData.Accordian2[i].nProductNo, jsonData.Accordian2[i].nProductTypeID, jsonData.Accordian2[i].nStudyProductBatchNo, jsonData.Accordian2[i].iPeriod);
                    ActivityDataset.push(InDataset);

                }
                tableid = "tblAccountPmsLineClearance2";
                divid = "AccountLineClearance2";
                document.getElementById(divid).style.visibility = "visible";
                document.getElementById(tableid).style.visibility = "visible";
            }
                
            else if ($('#AccountcollapseFour').attr('aria-expanded') == "true") {
                var ActivityDataset = [];
                ...
                for (var i = 0; i < jsonData.Accordian4.length  ; i++) {
                    ...
                    $radioYes = '<input class="radio" type="radio" name=radio_' + [i + 1] + ' id=chkAccountYes_' + [4] + [i + 1] + ' value="Yes"/>';
                    $radioNo = '<input class="radio" type="radio" name=radio_' + [i + 1] + ' id=chkAccountNo_' + [4] + [i + 1] + ' value="No"/>';

                    InDataset.push(i + 1, jsonData.Accordian4[i].vCheckPoints, $radioYes, $radioNo, jsonData.Accordian4[i].vUserName, jsonData.Accordian4[i].dModifyOn, review, '', '', jsonData.Accordian4[i].nLineClearanceDtlNo, jsonData.Accordian4[i].cIsYesNo, jsonData.Accordian4[i].cIsQAReview, jsonData.Accordian4[i].vWorkSpaceId, jsonData.Accordian4[i].nProductNo, jsonData.Accordian4[i].nProductTypeID, jsonData.Accordian4[i].nStudyProductBatchNo, jsonData.Accordian4[i].iPeriod);
                    ActivityDataset.push(InDataset);

                }
                tableid = "tblAccountPmsLineClearance4";
                divid = "AccountLineClearance4";
                document.getElementById(divid).style.visibility = "visible";
                document.getElementById(tableid).style.visibility = "visible";
            }
        }
            ...
            otableProjectWiseAuditTrail = $('#' + tableid).dataTable({
                ...
                "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                    debugger;
                    if (aData[12] == setworkspaceid  && aData[16] == $("#DDLPeriod :selected").text()) {
                        if (aData[10] == "Yes") {
                        ...
                        if (aData[10] == "undefined") {
                            ...
                            $("#btnPmsSave3").show();
                            $("#btnPmsSave4").show();
                            $("#btnAccountPmsSave1").show();
                            $("#btnAccountPmsSave2").show();
                            $("#btnAccountPmsSave3").show();
                            $("#btnAccountPmsSave4").show();
                        ...
                        if (aData[11] == 'Y') {
                            ...
                            $("#btnPmsSave3").hide();
                            $("#btnPmsSave4").hide();
                            $("#btnAccountPmsSave1").hide();
                            $("#btnAccountPmsSave2").hide();
                            $("#btnAccountPmsSave3").hide();
                            $("#btnAccountPmsSave4").hide();
            ...
            if ($("#AccountabilityLineClearance").is(":visible")) {
                if (document.getElementById('AccountabilityLineClearance').checked) {
                    var table = $('#' + tableid).DataTable();
...
function saveDetails() {
    ...
    if (document.getElementById('LineClearance').checked) {
        ...
        if ($('#AccountcollapseOne').attr('aria-expanded') == "true") {
            var acc1 = $("#tblAccountPmsLineClearance1").dataTable().fnGetData();

            for (var i = 0; i < acc1.length; i++) {
                $cIsYEsNo = "";
             
                if ($("#tblAccountPmsLineClearance1 input[name='radio_" + (i + 1) + "']:checked").val() == "Yes") {
                    $cIsYEsNo = 'Y'
                }
                else if ($("#tblAccountPmsLineClearance1 input[name='radio_" + (i + 1) + "']:checked").val() == "No") {
                    $cIsYEsNo = 'N'
                }
                else if ($("#tblAccountPmsLineClearance1 input[name='radio_" + (i + 1) + "']:checked").val() == undefined) {
                    $cIsYEsNo = 'U'
                }
            ...
            var acc1 = $("#tblAccountPmsLineClearance2").dataTable().fnGetData();

            for (var i = 0; i < acc1.length; i++) {
                $cIsYEsNo = "";
                if ($("#tblAccountPmsLineClearance2 input[name='radio_" + (i + 1) + "']:checked").val() == "Yes") {
                    $cIsYEsNo = 'Y'
                }
                else if ($("#tblAccountPmsLineClearance2 input[name='radio_" + (i + 1) + "']:checked").val() == "No") {
                    $cIsYEsNo = 'N'
                }
                else if ($("#tblAccountPmsLineClearance2 input[name='radio_" + (i + 1) + "']:checked").val() == undefined) {
                    $cIsYEsNo = 'U'
                }
            ...
            var acc1 = $("#tblAccountPmsLineClearance4").dataTable().fnGetData();

            for (var i = 0; i < acc1.length; i++) {
                $cIsYEsNo = "";
                if ($("#tblAccountPmsLineClearance4 input[name='radio_" + (i + 1) + "']:checked").val() == "Yes") {
                    $cIsYEsNo = 'Y'
                }
                else if ($("#tblAccountPmsLineClearance4 input[name='radio_" + (i + 1) + "']:checked").val() == "No") {
                    $cIsYEsNo = 'N'
                }
                else if ($("#tblAccountPmsLineClearance4 input[name='radio_" + (i + 1) + "']:checked").val() == undefined) {
                    $cIsYEsNo = 'U'
                }
    ...
    if (iTypeOfAccordian == "2")
    {
        if (document.getElementById('LineClearance').checked) {
            ...
            if ($("#DDLAccountProductType").val() == 0) {
                ValidationAlertBox("Please select Product Type.", "DDLProductType", ModuleName);
                return false;
            }

            else if ($("#DDLAccountProduct").val() == 0) {
                ValidationAlertBox("Please select Product.", "DDLProduct", ModuleName);
                return false;
            }

            else if ($("#ddlAccountBatchLotNo").val() == 0) {
                ValidationAlertBox("Please select Batch/Lot/Lot No.", "ddlBatchLotNo", ModuleName);
                return false;
            }
    ...
    function SuccessMethod(jsonData) {
        ...
        if (jsonData == "success") {
            ...
            if (document.getElementById('LineClearance').checked) {
                ...
                // $('#collapseThree').collapse('hide');
                $('#AccountcollapseFour').collapse('hide');
                SuccessorErrorMessageAlertBox("Accountability Line Clearance saved successfully.", ModuleName);
            }
...
function EditData(e) {
    ...
    if (document.getElementById('LineClearance').checked) {
        if ($('#collapseOne').attr('aria-expanded') == "true") {
            ...
            if (acc1[0][11] == 'Y') {
                SuccessorErrorMessageAlertBox("QA/QC review is done so data can not be changed.", ModuleName);
                return false;
            }
            if (acc1[0][11] == 'R') {
                SuccessorErrorMessageAlertBox("QA/QC review is done so data can not be changed.", ModuleName);
            ...
            if (acc1[0][11] == 'Y') {
                SuccessorErrorMessageAlertBox("QA/QC review is done so data can not change !", ModuleName);
                return false;
            }
            if (acc1[0][11] == 'R') {
                SuccessorErrorMessageAlertBox("QA/QC review is done so data can not be changed.", ModuleName);
            ...
            //    }
            //    if (acc1[0][11] == 'R') {
            //        SuccessorErrorMessageAlertBox("QA review is done so data can not be changed.", ModuleName);
            //    }
            //    else {
            //        for (var i = 0; i < acc1.length; i++) {
        ...
        if ($('#AccountcollapseOne').attr('aria-expanded') == "true") {
            ...
            if (acc1[0][11] == 'R') {
                ...
                for (var i = 0; i < acc1.length; i++) {
                    var data = $("#tblAccountPmsLineClearance1").dataTable().fnGetData(i);
                    if (data[9] == nLineClearanceDtlNo) {
                        $("#chkAccountYes_" + [1] + [i + 1] + "").attr('disabled', false);
                        $("#chkAccountNo_" + [1] + [i + 1] + "").attr('disabled', false);
                        $("#btnAccountPmsSave1").show();
                    }
                    else {
                        continue;
            ...
            if (acc1[0][11] == 'R') {
                ...
                for (var i = 0; i < acc1.length; i++) {
                    var data = $("#tblAccountPmsLineClearance2").dataTable().fnGetData(i);
                    if (data[9] == nLineClearanceDtlNo) {
                        $("#chkAccountYes_" + [2] + [i + 1] + "").attr('disabled', false);
                        $("#chkAccountNo_" + [2] + [i + 1] + "").attr('disabled', false);
                        $("#btnAccountPmsSave2").show();
                    }
                    else {
                        continue;
            ...
            if (acc1[0][11] == 'R') {
                ...
                for (var i = 0; i < acc1.length; i++) {
                    var data = $("#tblAccountPmsLineClearance4").dataTable().fnGetData(i);
                    if (data[9] == nLineClearanceDtlNo) {
                        $("#chkAccountYes_" + [4] + [i + 1] + "").attr('disabled', false);
                        $("#chkAccountNo_" + [4] + [i + 1] + "").attr('disabled', false);
                        $("#btnAccountPmsSave4").show();
                    }
                    else {
                        continue;
...
var GetAllLineClearanceAuditData = function (Url, SuccessMethod, Data) {
    ...
    function SuccessMethod(jsonData) {
        ...
        for (var i = 0; i < jsonData.length; i++) {
            ...
            InDataset.push(jsonData[i].vCheckPoints, jsonData[i].cIsYesNo, jsonData[i].vUserName, jsonData[i].dModifyOn, operation, jsonData[i].vQARemarks, jsonData[i].iQAReviewBy, jsonData[i].dQAReviewOn, jsonData[i].iLineClearanceHstNo
                            );
            ActivityDataset.push(InDataset);
        }
        otable = $('#tblAuditTrail').dataTable({
            ...
            "aoColumns": [
                ...
                { "sTitle": "Modify On" },
                { "sTitle": "Operation" },
                { "sTitle": "QA/QC Review Remarks" },
                { "sTitle": "QA/QC Review By" },
                { "sTitle": "QA/QC Review On" },
            ...
            if (document.getElementById('AccountabilityLineClearance').checked) {
                var table = $('#tblAuditTrail').DataTable();
...
$('input[type=radio][name=rbl_LineClearance]').on('change', function () {
    debugger;
    SetDefaultValue();
    //if (this.value == 'rbl_LineClearance') {
    //    $("#divLineClearance").show();
    //    $("#divAccountabilityLineClearance").hide();
    //}
    //else if (this.value == 'rbl_AccountabilityLineClearance') {
    //    $("#divAccountabilityLineClearance").show();
    //    $("#divLineClearance").hide();
    //}
});