...
var vnProductNo;
var flag;
var ModuleName = "IP Issue/Adjustment";
var TransferIndi = "";
...
$(document).ready(function () {
    ...
    $("#btnSavePmsProductReceipt").on("click", function () {
        ...
        var InsertProductReceiptData = {
            Url: BaseUrl + "IPIssue/InsertPmsProductReceiptHeader",
            SuccessMethod: "SuccessMethod",
    ...
    function SuccessMethod(jsonData) {
        ...
        if (jsonData.length > 0) {
            ...
            var GetPmsStudyReceiptBatchLotNo = {
                Url: BaseUrl + "IPIssue/GetBatchLotNo",
                SuccessMethod: "SuccessMethod"
            }
            $.ajax({
...
function GetStorageName() {
    var GetPmsStoragename = {
        Url: BaseUrl + "IPIssue/GetStoragename",
        SuccessMethod: "SuccessMethod"
    }
    $.ajax({
    ...
    if (ntransactionno == "" && nspttransactiondtlno == "") {
        ...
        for (i = 0; i < data.length; i++) {
            ...
            var InsertProductReceiptData2 = {
                Url: BaseUrl + "IPIssue/InsertPmsProductReceiptDetails",
                SuccessMethod: "SuccessMethod",
        ...
        SuccessorErrorMessageAlertBox("IP Issue/Adjustment saved successfully.", ModuleName);
    }
    else if (ntransactionno != "" && nspttransactiondtlno != "") {
        var storagearea = $("#StorageArea").val();
        if (storagearea == null) {
...
function GetDashBoardData() {
    ...
    {
        Url: BaseUrl + "IPIssue/StudyProductReceiptData",
        SuccessMethod: "SuccessMethod",
...
function GetExpiryDate() {
    ...
    var GetPMSStudyProductReceiptExpiryData = {
        Url: BaseUrl + "IPIssue/ExpiryDate",
        SuccessMethod: "SuccessMethod",
        Data: ExpiryDatedata
    }
...
function GetExportToExcelDetails() {
    ...
    var url = WebUrl + "IPIssue/GetExportToExcelDetails";
    $.ajax({
        url: url,
        type: 'get',
        data: Data_Export,
...
function pmsStudyProductReceiptSelectionData(e) {
    ...
    var GetPMSStudyProductReceiptSelection = {
        Url: BaseUrl + "IPIssue/StudyProductSelectionData",
        SuccessMethod: "SuccessMethod",
...
function pmsProductReceiptAuditTrail(nTransactionNo) {
    ...
    $.ajax({
        url: BaseUrl + "IPIssue/GetProductReceiptAudit/" + nTransactionNo + "",
        type: 'GET',
...
function ExportToExcelAuditTrail(nTransactionNo) {
    ...
    var url = WebUrl + "IPIssue/GetExportToExcelDetailsAuditTrail";
    $.ajax({
        url: url,
        type: 'get',
...
$("#btnOk").on("click", function () {
    ...
    var InsertProductReceiptData = {
        Url: BaseUrl + "IPIssue/InsertPmsProductReceiptDtlQA",
        SuccessMethod: "SuccessMethod",
        Data: InsertPmsProductReceipt1
    }
    ...
    $.ajax({
        ...
        success: function (jsonData) {
            if (jsonData == "success") {
                ...
                $("#txtPassword").val('');
                GetDashBoardData();
                SuccessorErrorMessageAlertBox("IP Issue/Adjustment reviewed successfully.", ModuleName);
            }
...
function QaReviewReject() {
    ...
    //    Url: BaseUrl + "IPIssue/InsertPmsProductReceiptDtlQARejected",
    //    SuccessMethod: "SuccessMethod",
    ...
    $.ajax({
        ...
        success: function (jsonData) {
            if (jsonData == "success") {
                ...
                $("#txtRemark").val('');
                $("#txtPassword").val('');
                SuccessorErrorMessageAlertBox("IP Issue/Adjustment rejected successfully.", ModuleName);
                GetDashBoardData();
            }
            else if (jsonData == "error") {
                $("#ViewAuthenticate").show();
